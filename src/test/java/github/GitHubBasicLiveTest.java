...
public class GitHubBasicLiveTest {
    ...
    // este otestovat ci spravny user vracia spravny kod
    ...
    public void givenUserDoesNotExists_whenUserInfoIsRetrieved_then404IsReceived() throws ClientProtocolException, IOException {
        // Given
        final String name = "thisnamesurelydoesnotexistingithub";
    ...
    public void givenUserExists_whenUserInformationIsRetrieved_thenRetrievedResourceIsCorrect() throws ClientProtocolException, IOException {
        // Given
        final HttpUriRequest request = new HttpGet("https://api.github.com/users/eugenps");
        ...
        // tieto hodnoty su vymenene
    }

    @Test
    public void testingOutputTemporaryTest() throws IOException {
        // Given
        final HttpUriRequest request = new HttpGet("https://api.github.com/users/eugenps");
        ...
        // Then
        String resource = RetrieveUtil.getResource(response);
